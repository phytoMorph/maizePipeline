function [swell_fileOut,area_fileOut,para_fileOut,err_fileOut,fit_fileOut] = generateOutFileBase(inFile1,oPath,numDeep)
    ...
    fit_fileOut = [oPath 'fit--' fileName '--' '#ROWNUM#' '.csv'];
end